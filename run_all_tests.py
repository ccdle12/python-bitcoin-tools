...
helper.run_test(ecc.ECC_Tests('test_uncompressed_SEC'))
helper.run_test(ecc.ECC_Tests('test_compressed_SEC_1'))
helper.run_test(ecc.ECC_Tests('test_compressed_SEC_2'))
helper.run_test(ecc.ECC_Tests('test_compressed_SEC_1_EVEN'))
helper.run_test(ecc.ECC_Tests('test_compressed_SEC_2_ODD'))